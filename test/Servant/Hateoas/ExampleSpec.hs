    ...
    describe "Collection API" $
      describe "UserGetAll (GET /api/user)" $
        it "returns all users as a HAL collection" $
          get "/api/user" `shouldRespondWith` 200 { matchBody = bodyEquals "{\"_embedded\":{\"items\":[{\"_embedded\":{},\"_links\":{\"address\":{\"href\":\"/api/address/1\",\"type\":\"application/hal+json\"}},\"addressId\":1,\"income\":1000,\"usrId\":1},{\"_embedded\":{},\"_links\":{\"address\":{\"href\":\"/api/address/2\",\"type\":\"application/hal+json\"}},\"addressId\":2,\"income\":2000,\"usrId\":2},{\"_embedded\":{},\"_links\":{\"address\":{\"href\":\"/api/address/3\",\"type\":\"application/hal+json\"}},\"addressId\":3,\"income\":3000,\"usrId\":42}]},\"_links\":{\"self\":{\"href\":\"/api/user\",\"type\":\"application/hal+json\"}}}" }
  with (pure collectionApp) $
    describe "Collection API" $
      describe "UserGetAll (GET /api/user)" $
        it "returns all users as a HAL collection" $
          get "/api/user" `shouldRespondWith` 200 { matchBody = bodyEquals "{\"collection\":{\"items\":[{\"data\":[{\"name\":\"usrId\",\"value\":42},{\"name\":\"income\",\"value\":3000},{\"name\":\"addressId\",\"value\":3}],\"links\":[{\"name\":\"address\",\"value\":\"/api/address/3\"}]},{\"data\":[{\"name\":\"usrId\",\"value\":2},{\"name\":\"income\",\"value\":2000},{\"name\":\"addressId\",\"value\":2}],\"links\":[{\"name\":\"address\",\"value\":\"/api/address/2\"}]},{\"data\":[{\"name\":\"usrId\",\"value\":1},{\"name\":\"income\",\"value\":1000},{\"name\":\"addressId\",\"value\":1}],\"links\":[{\"name\":\"address\",\"value\":\"/api/address/1\"}]}],\"links\":[{\"name\":\"self\",\"value\":\"/api/user\"}],\"version\":\"1.0\"}}" }
