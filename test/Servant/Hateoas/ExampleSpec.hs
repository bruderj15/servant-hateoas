...
spec = do
  ...
  with (pure collectionApp) $
    describe "Collection API" $
      describe "UserGetAll (GET /api/user)" $
        it "returns all users as a HAL collection" $
          get "/api/user" `shouldRespondWith` 200 { matchBody = bodyEquals "{\"collection\":{\"items\":[{\"data\":[{\"name\":\"usrId\",\"value\":42},{\"name\":\"income\",\"value\":3000},{\"name\":\"addressId\",\"value\":3}],\"links\":[{\"href\":\"/api/address/3\",\"rel\":\"address\"},{\"href\":\"/api/user/42\",\"rel\":\"self\"}]},{\"data\":[{\"name\":\"usrId\",\"value\":2},{\"name\":\"income\",\"value\":2000},{\"name\":\"addressId\",\"value\":2}],\"links\":[{\"href\":\"/api/address/2\",\"rel\":\"address\"},{\"href\":\"/api/user/2\",\"rel\":\"self\"}]},{\"data\":[{\"name\":\"usrId\",\"value\":1},{\"name\":\"income\",\"value\":1000},{\"name\":\"addressId\",\"value\":1}],\"links\":[{\"href\":\"/api/address/1\",\"rel\":\"address\"},{\"href\":\"/api/user/1\",\"rel\":\"self\"}]}],\"links\":[{\"href\":\"/api/user\",\"rel\":\"self\"}],\"version\":\"1.0\"}}" }
